...
public class DateHelper {
	...
	private static final SimpleDateFormat FULL_DATE_FORMATTER = new SimpleDateFormat("MM/dd/yyyy 'at' HH:mm");

	private static final SimpleDateFormat SHORT_DATE_FORMATTER = new SimpleDateFormat("MM/dd/yyyy");
